...
<head>
    ...
    <title>BHTC - User Dashboard</title>
...
<body>
    ...
    <header class="navbar">
        <div class="nav-container">
            <div class="logo">
                <span class="logo-icon">🎓</span> <span class="logo-text">BHTC</span>
            </div>
            <nav class="nav-links">
                <a href="#">Home Page</a>
                <a href="#">About Us</a>
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" id="fullname" value="Vikas Kumar" placeholder="Enter your full name">
                            </div>

                            <div class="form-group">
                                <label for="email">Email Address</label>
                                <input type="email" id="email" value="addsfdfmin@gmail.com" placeholder="Enter email address">
                            </div>

                            <div class="form-group">
                                <label for="phone">Phone Number</label>
                                <input type="text" id="phone" value="+91 9876543210" placeholder="Enter phone number">
                            </div>

                            <div class="form-group">
                                <label for="course">Current Course / Batch</label>
                                <input type="text" id="course" value="Academic Coaching - Class X" readonly class="readonly-input">
                            </div>

                            <div class="form-group full-width">
                                <label for="address">Correspondence Address</label>
                                <textarea id="address" rows="3" placeholder="Enter your complete address">123, Learning Street, Near Education Hub, Indore</textarea>
                            </div>
