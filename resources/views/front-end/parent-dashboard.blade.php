    ...
    <main class="dashboard-container">
        ...
        <section class="content-area">
            <div class="profile-card">
                ...
                <div class="card-body">
                    <form action="{{ route('parent.profile.store')}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" id="phone"  value="{{ old('phone', $user->phone) }}" placeholder="Enter phone number">
                            </div>

                            <div class="form-group">
                                <label for="phone">Mother Name</label>
                                <input type="text" name="mother_name"  value="{{ old('mother_name', $user->parent?->mother_name) }}" placeholder="Enter Mother Name">
                            </div>

                            <div class="form-group">
                                <label for="course">Occupation</label>
                                <input type="text" name="occupation" value="{{ old('occupation', $user->parent?->occupation) }}" >
                            </div>

                            <div class="form-group">
                                <label for="address">Correspondence Address</label>
                                <textarea name="address" id="address" rows="3" value="" placeholder="Enter your complete address">{{ old('address', $user->parent?->address) }}</textarea>
                            </div>
